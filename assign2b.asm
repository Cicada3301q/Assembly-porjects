...
main:	stp x29, x30, [sp, -16]						//save FP and LR to stack, allocation 16 bytes, preincrement SP
	...
	movk multiplicand_r, 0x1f1f, lsl 0				//initialize multiplier macro with the value -16843010, store first half in mult_r
	movk multiplicand_r, 0x1f1f, lsl 16				//places the second half of the hex representation of -16843010 in mult_r
	mov mult_r, 200							//moves 70 into our multiplicand register
